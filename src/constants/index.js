...
const experiences = [
  {
    ...
    company_name: "Computer Engineering Society",
    icon: CES,
    iconBg: "black",
...
const educations = [
  {
    ...
    institute_name: "Madan Mohan Malviya University of Technology, Gorakhpur",
    icon: mmmut,
    iconBg: "black",
    date: "2022 - Pursuing",
  ...
  {
    title: "XII",
    institute_name: "H.A.L Vidyalaya, Kanpur (C.B.S.E)",
    icon: halv,
    iconBg: "black",
    date: "2021-2022",
    fos: "",
    cgpa: "96.20%",
    special_mentions: "School Topper",
  },
  {
    title: "X",
    institute_name: "Methodist High School, Kanpur (I.C.S.E)",
    icon: mhs,
    iconBg: "black",
    date: "2019-2020",
    fos: "",
