  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      "template_4w4z20c",
      {
        ...
        to_email: "whilealivecode127.0.0.1@gmail.com",
        ...
        >
          <label className="flex flex-col">
            ...
            <input
              ...
              className="bg-tertiary py-4 px-6 placeholder:text-secondry placeholder:text-[14px] text-white rounded-lg outline-none border-none font-medium"
            />
          </label>
